...
<div class="page-header">
	<div class="add-item d-flex">
		<div class="page-title">
			...
			<h6>Total <?php echo count($inquiries); ?> inquiries found.</h6>
		</div>
	</div>
								...
								<tr>
									...
									<td class="d-flex">
										<div class="edit-delete-action d-flex align-items-center">
											<a class="p-2 d-flex align-items-center border rounded" href="<?php echo $site[0]["website_url"]; ?>admin/inquiry/submit.php?action=delete&no=<?php echo $val['no']; ?>" onclick="return confirm('Are you sure to remove this inquiry?')">
